...
import 'package:eco_commerce_app/util/MultiListHandeler.dart';
        ...
        builder: (_, currentUser, __)
    {
      ...
      return WillPopScope(
        ...
        child: Scaffold(
          ...
          backgroundColor: Colors.white,
          drawer: MainDrawer(),
          body:(products == null || isLoading == true)?Container(width: width,child: LinearProgressIndicator(),):MultiListHandler(height: height,width: width,products: products),
        ),
      );
    },
  );
