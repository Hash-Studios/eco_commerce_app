...
class PopularSliderWidget extends StatefulWidget {
  final List<Widget> header;
  PopularSliderWidget({this.header});
  @override
  _PopularSliderWidgetState createState() => _PopularSliderWidgetState();
}


class _PopularSliderWidgetState extends State<PopularSliderWidget> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: ((widget.header!=null)?widget.header:<Widget>[])+<Widget>[
        Container(
